...
def get_args_parser():
    parser = argparse.ArgumentParser('DropPos fine-tuning for image classification', add_help=False)
    ...
    parser.add_argument('--fix_pos_emb', action='store_true',
                        help='Fix positional embeddings when fine-tuning.')
    parser.set_defaults(fix_pos_emb=False)
